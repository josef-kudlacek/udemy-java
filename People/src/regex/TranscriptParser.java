...
public class TranscriptParser {
    public static void main(String[] args) {
        ...
        Cumulative\\sGPA\\s\\(Weighted\\)\\s+(?<weightedGPA>\\d{1,}\\.\\d{1,})\\b.* # Get's cumulative GPA Weighted
        Cumulative\\sGPA\\s\\(Unweighted\\)\\s+(?<unweightedGPA>\\d{1,}\\.\\d{1,})\\b.* # Get's cumulative GPA Unweighted
        (.*) # Rest of transcript
        """;
