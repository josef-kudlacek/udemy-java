...
//            totalSalaries += employee.getSalary();
        ...
        for (IEmployee employeeElement : employeeList) {
            ...
            if (employeeElement instanceof Employee) {
                Employee tempEmployee = (Employee) employeeElement;

                if (removalFirstNames.contains(tempEmployee.getFirstName())) {
                    employeeList.remove(employeeElement);
                }
            }
